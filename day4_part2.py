...
def run_through(draws, bords_values, bords_bools, w_list):
...
if __name__ == '__main__':
    ...
    winlist = []
    final_number, i, losing_bord = run_through(draws_, bords_values_, bords_bools_, winlist)
    numbers = get_sum(losing_bord, bords_values_[i])
